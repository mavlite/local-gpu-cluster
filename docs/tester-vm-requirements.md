...
Router forwards `<external port>` → `192.168.6.175:2222`; the host DNATs `2222` → `10.78.0.10:22`.
Port 2222 is free on the host (in use: 22, 25, 85, 111, 3128, 8006, 8888, 9100). A non-22
